...
class FeaturedProductsWidget extends StatelessWidget {
  final AsyncValue<List<ProductModel>> featuredProductsAsyncValue;

  FeaturedProductsWidget({required this.featuredProductsAsyncValue});

  @override
  Widget build(BuildContext context) {
    return _buildProductListSection('Featured Products', featuredProductsAsyncValue, context);
  }

  // Helper method to build the product section (with shimmer, loading, etc.)
  ...
  // Build individual product item with product image, name, price, and additional information
          ...
          children: [
            Stack(
              children: [
                ...
                // If the product has additional text, show it in a badge-like container
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // If a discount is present, show the original price with a strikethrough
